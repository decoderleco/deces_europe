...
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_allemagne, 30000, 150000, 30000, 150000, 166)

a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_armenie, 250, 150000, 250, 8500, 113)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_autriche, 15, 80000, 80, 250000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_belgique, 20, 150000, 120, 650000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_chypre, 6, 15000, 10, 50000, 113)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_croatie, 10, 20000, 100, 100000, 61)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_danmark, 10, 150000, 60, 300000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_espagne, 50, 1100000, 600, 3000000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_estonie, 6, 10000, 30, 40000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_finlande, 15, 100000, 60, 180000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_france, 80, 800000, 600, 3000000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_grece, 20, 150000, 120, 400000, 113)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_hongrie, 20, 150000, 200, 300000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_islande, 4, 15000, 8, 30000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_italie, 60, 400000, 600, 2000000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_malte, 4, 10000, 10, 50000, 10)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_norvege, 10, 80000, 40, 200000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_paysbas, 20, 150, 130, 150)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_pologne, 100, 190000, 700, 1000000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_portugal, 10, 500000, 150, 800000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_serbie, 10, 150000, 150, 1500000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_suede, 20, 150000, 80, 400000)
a__f_plot_es_deces_hebdo_std_vaccination(es_deces_standard_pays_semaine_suisse, 10, 150000, 80, 150000)
