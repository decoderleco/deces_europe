...
Cette hausse du nombre de décès n’est pas le signe que la santé des français se dégrade, mais uniquement le résultat de l'augmentation du nombre de personnes âgées. En effet, à force de vieillir, tous les humains finissent par mourir. Pour l'illustrer, voici la pyramide des âges de la France en 2000 et en 2020, réalisée avec les données disponibles sur Eurostat.
 ...
 ![](gen/images/Eurostat/Pyramides/Eurostat_Pyramide_france_2000.png){width=450px} ![](gen/images/Eurostat/Pyramides/Eurostat_Pyramide_france_2020.png){width=450px}
...
Cette carte d’Europe représente l’année pour laquelle chaque pays européen, dont nous disposons des données, a connu le plus de décès.
 ...
 ![](gen/images/Eurostat/Deces/Annuel/Cartes/Eurostat_Deces_Annee_Maximum.png)
...
La pyramide des âges des pays Européens révèle une situation européenne semblable à celle de la France : la population vieillit. Il est tout à fait normal que le nombre de décès augmente chaque année du fait de ce simple constat.
 ...
 ![](gen/images/Eurostat/Pyramides/Eurostat_Pyramide_europe_2000.png){width=450px} ![](gen/images/Eurostat/Pyramides/Eurostat_Pyramide_europe_2020.png){width=450px}
...
En calculant pour chaque pays, les décès standardisés par âge, pour toutes les années, il est désormais possible de les comparer aux décès 2020. Cela permet de savoir si à population égale, l’année 2020 a été réellement plus mortelle que les autres. Ce calcul, permet de déger 5 profils type de pays représentés sur cette carte.
 ...
 ![](gen/images/Eurostat/Deces/Annuel/Cartes/Eurostat_Deces_2020_Typologie.png)
...
![](gen/images/Eurostat/Deces/Annuel/Evol/Eurostat_Deces_2000_2020_zone_est.png){width=1000px} 
![](gen/images/Eurostat/Deces/Annuel/Evol/Eurostat_Deces_2000_2020_zone_ouest.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Annuel/Evol/Eurostat_Deces_2000_2020_par_3annees.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/france.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_FR_SU_PO/Deces_Hebdo_france_suede_portugal.png){width=1000px}
...
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/IledeFrance.png){width=1000px}
A l'inverse, en Nouvelle-Aquitaine, auncune hausse de mortalité n'est visible sur la période.

![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/NouvelleAquitaine.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/chypre.png){width=1000px}
...
![](gen/images/fr/Medicam/Medicam_Vaccins_Grippe_Distribues.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Est/hongrie.png){width=1000px}

Le focus sur le moins de 40 ans qui ne décèdent que très peu lors des épisodes hivernaux confirme ce résultat.

![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/lt40/Est/hongrie.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/malte.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/islande.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/norvege.png){width=1000px}

Pour les jeunes également, la mortalité reste à son niveau bas, même si on note une dynamique en augmentation.


![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/lt40/Ouest/norvege.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Est/croatie.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/lt40/Est/croatie.png){width=1000px}
...
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/france.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/belgique.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/suisse.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/espagne.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/italie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/luxembourg.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/paysbas.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/suede.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/chypre.png){width=1000px}


### Pays ne présentant pas de pic de mortalité en mars-avril 2020

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/portugal.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/malte.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/autriche.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/hongrie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/bulgarie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/rtcheque.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/danmark.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/estonie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/croatie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/islande.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/lichtenstein.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/lettonie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/montenegro.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/norvege.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/pologne.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/serbie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/slovaquie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/slovenie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Ouest/allemagne.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/albanie.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/grece.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/finlande.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/roumanie.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/Deces_Pays/ge40/Est/armenie.png){width=1000px}

## Les décès confrontés à la vaccination Covid par pays

![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Est/hongrie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/malte.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/france.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/islande.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Est/chypre.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/allemagne.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/autriche.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/belgique.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/suisse.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/espagne.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/paysbas.png){width=1000px}


![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Est/pologne.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/danmark.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/suede.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Est/grece.png){width=1000px}

![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Est/croatie.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Ouest/norvege.png){width=1000px}
![](gen/images/Eurostat/Deces/Hebdo/Std/owid/Deces_Pays_Vaccin/ge65/Est/serbie.png){width=1000px}

## Les décès quotidiens par département français

![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/BourgogneFrancheComte.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/AuvergneRhoneAlpes.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/PaysdelaLoire.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/PACA.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/IledeFrance.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/NouvelleAquitaine.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/HautsdeFrance.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/GrandEst.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/Occitanie.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/Corse.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/Bretagne.png){width=1000px}
![](gen/images/fr/gouv/Registre/Deces_Quotidiens/Region/CentreValdeLoire.png){width=1000px}