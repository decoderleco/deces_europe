...
Toutes les données de mortalité utilisées dans cet articles, sont des données de mortalités toutes causes confondues et pas uniquement des données de mortalité de la seule cause Covid-19. En effet pour considérer qu'une maladie est mortelle, il faut qu'elle ait un impact sur la mortalité générale, et pas uniquement compter les décès de personnes qui en sont porteuses. En effet, cela n'aurait aucun sens statistique de compter les décès survenus après la dégustation d'une glace à la vanille. Pourtant en le faisant nous verrions une forte augmentation de ces décès l'été, uniquement parce qu'en France 1500 personnes décèdent tous les jours l'été, et qu'à cette période, elles dégustent plus souvent des glaces à la vanille. Il s'agit de ce que l'on appelle un biais de perception.
...
Pour cette raison, cet article se base uniquement sur les décès toutes causes et met en lien les différents évènements et choix qui ont cours dans les différents pays, afin de chercher des causes de décès sans biais préalable.

Les décès des données toutes causes sont étonnament et malheureusement beaucoup plus difficiles à trouver. Elles ne bénéficient pas de la diffusion des statistiques de la Covid et ses nombreux sites internet redoublant d'interfaces graphiques. Ils doivent être téléchargé sur des sites spécilisés et retravaillés pour les rendre exploitables. Ils sont pourtant les seuls permettant une analyse objective la situation.
...
![](BourgogneFrancheComté.png){width=1000px}
![](AuvergneRhôneAlpes.png){width=1000px}
![](PaysdelaLoire.png){width=1000px}
![](PACA.png){width=1000px}
![](ÎledeFrance.png){width=1000px}
![](NouvelleAquitaine.png){width=1000px}
![](HautsdeFrance.png){width=1000px}
![](GrandEst.png){width=1000px}
![](Occitanie.png){width=1000px}
![](ÎledeFrance.png){width=1000px}
![](Corse.png){width=1000px}
![](Bretagne.png){width=1000px}
![](CentreValdeLoire.png){width=1000px}